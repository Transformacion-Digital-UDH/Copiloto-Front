...
<template>
    <header class="flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-800 dark:text-white border-b-2 border-custom-green" >
      <div class="flex items-center">
  
        <!-- boton hamburguesa cerrar y abrir menu de navegacion -->
        <button @click="isOpen = true" class="text-[#2ebaa1] focus:outline-none lg:hidden">
      ...
      <div class="flex items-center">
        ...
        <button @click="toggleDark()" class="flex dark:text-gray-100 text-gray-900 focus:outline-none">
          <!-- svg moon -->
        ...
        <button class="flex mx-4 dark:text-gray-100 text-gray-700 focus:outline-none">
        ...
        <div class="relative">
          <button @click="dropdownOpen = !dropdownOpen" class="relative z-10 block w-10 h-10 overflow-hidden rounded-full shadow focus:outline-none">
            <img class="object-cover w-full h-full" src="https://images.unsplash.com/photo-1528892952291-009c663ce843?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=296&q=80" alt="Avatar Estudiante"
            />
          </button>
