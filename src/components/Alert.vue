<template>
  <div v-if="isVisible" :class="`fixed top-4 right-4 p-4 rounded-lg shadow-lg bg-white text-black w-96`">
    <div class="flex items-center">
      ...
      <div :class="`w-10 h-10 mr-2 ${iconColor}`">
        ...
        <svg v-if="type === 'warning'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M5.22 4.22a8 8 0 0111.56 0A8 8 0 0112 20a8 8 0 01-6.78-11.78z" />
        </svg>
      </div>
      <p>{{ message }}</p>
    </div>
