                ...
                <table class="min-w-full leading-normal">
                  <thead class="custom-thead font-Quicksand">
                    <tr class="text-center text-azul border-b-2 bg-gray-300">
                      ...
                      <th class="py-2 px-3 tracking-wider">CONFORMIDAD JURADO</th>
                  ...
                  <tbody>
                    <tr v-for="(solicitude, index) in filteredTableData" :key="solicitude.oficio_id"
                      ...
                      <td class="text-center px-3">
                        <a v-if="solicitude.oficio_id" :href="`${VIEW_CPA}/${solicitude.revision_id_asesor}`"
                          target="_blank">
                          <button>
                      ...
                      <td class="text-center px-4">
                        <div class="flex justify-center items-center">
                          <!-- Botón de Documentos -->
                          <button @click="openDocumentModal(
                            ...
                            <span class="text-[#34495e]">Informes de<br>Conformidad</span>
                          </button>
                        </div>
                      </td>
                      ...
                      <td class="px-3 py-5 flex flex-col items-center justify-center">
                        ...
                        <button>
                          <a :href="`${VIEW_APAISI}/${solicitude.oficio_id}`" target="_blank"
                            class="flex items-center m-2 relative group"
          ...
          <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
            ...
            <div class="p-6 bg-white rounded-lg">
              ...
              <div class="flex justify-between items-center" v-if="presidenteId">
                ...
                <a :href="`${VIEW_CPA}/${presidenteId}`" target="_blank" @mouseenter="isHovered = true"
                  @mouseleave="isHovered = false" class="flex items-center m-2 relative group">
                  <IconEyeCerrar class="mr-1 group-hover:hidden" />
                  <IconEyeAbrir class="mr-1 hidden group-hover:block" />
              ...
              <div class="flex justify-between items-center" v-if="secretarioId">
                ...
                <a :href="`${VIEW_CPA}/${secretarioId}`" target="_blank" @mouseenter="isHovered = true"
                  @mouseleave="isHovered = false" class="flex items-center m-2 relative group">
                  <IconEyeCerrar class="mr-1 group-hover:hidden" />
                  <IconEyeAbrir class="mr-1 hidden group-hover:block" />
                  <span class="text-[#34495e]">Visualizar</span>
              ...
              <div class="flex justify-between items-center" v-if="vocalId">
                ...
                <a :href="`${VIEW_CPA}/${vocalId}`" target="_blank" @mouseenter="isHovered = true"
                  @mouseleave="isHovered = false" class="flex items-center m-2 relative group">
                  <IconEyeCerrar class="mr-1 group-hover:hidden" />
                  <IconEyeAbrir class="mr-1 hidden group-hover:block" />
                  <span class="text-[#34495e]">Visualizar</span>
