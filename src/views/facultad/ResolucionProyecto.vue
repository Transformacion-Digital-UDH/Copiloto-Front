...
// Validación para N° de expediente: hasta 4 caracteres con números y un guion permitido
const validateNroExped = () => {
  ...
  if (nroExped1.value.length > 4) {
    nroExped1.value = nroExped1.value.slice(0, 4); // Limitar a 4 caracteres
  }
};
                ...
                <tbody>
                  <tr v-for="(solicitude, index) in filteredTableData" :key="solicitude.resolucion_id"
                    ...
                    <td class="text-center px-3 py-2">
                      <a v-if="solicitude.oficio_id" :href="`${VIEW_APROBACIONPAISI}/${solicitude.oficio_id}`"
                        target="_blank">
                        <button>
                    ...
                    <td class="px-3 py-5 flex flex-col items-center justify-center">
                      <button v-if="['pendiente', 'observado'].includes(solicitude.estado ?? '')"
                        :class="['w-20 px-2 py-1 mb-2 text-sm text-white bg-base rounded-xl focus:outline-none', 'hover:bg-green-600']"
                      ...
                      <button>
                        <a :href="`${VIEW_APROBACIONFACULTAD}/${solicitude.resolucion_id}`" target="_blank"
                          class="flex items-center m-2 relative group" v-if="['tramitado'].includes(solicitude.estado)">
      ...
      <div v-if="showModal"
        ...
        <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
          ...
          <div class="flex items-center justify-end p-3 border-t border-gray-200">
            ...
            <button class="ml-4 px-4 py-2 text-sm font-Thin 100 text-white bg-base rounded-2xl" :disabled="!formIsValid"
      ...
      <div v-if="showRejectModal"
        ...
        <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
          ...
          <div class="flex items-center justify-end p-3 border-t border-gray-200">
            ...
            <button class="ml-4 px-4 py-2 text-sm font-Thin 100 text-white bg-base rounded-2xl"
