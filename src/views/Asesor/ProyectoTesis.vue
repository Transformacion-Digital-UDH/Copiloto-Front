...
// simulacion de datos
const tableData = ref([
    { name: 'Estudiante 1', title: 'Titulo 1 Implementacion de un algoritmo muy basico para que los estudiantes entiendan y sepan que hacer con dicho algoritmo', obs:'5', status: 'Completado', statusColor: 'estadoVerde'},
    { name: 'Estudiante 2', title: 'Titulo 2', obs:'15', status: 'Pendiente', statusColor: 'estadoPlomo'},
    { name: 'Estudiante 3', title: 'Titulo 3', obs:'25', status: 'En proceso', statusColor: 'yellow'},
])
...
const filteredTableData = computed(() => {
    ...
    if (selectedFilter.value){
        filteredData = filteredData.filter(data => data.status === selectedFilter.value);
    }
        ...
        <div class="flex-1 p-10 overflow-auto">
            ...
            <div class="mt-8">
                <div class="mt-6">
                    <div class="flex flex-col mt-3 sm:flex-row font-Roboto">
                        ...
                        <div class="flex">
                            <div class="relative">
                                <select v-model="rowsPerPage" class="block w-full h-full px-4 py-2 pr-8 leading-tight text-gray-700 bg-white border border-gray-400 rounded-l appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                    ...
                    <div class="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8 mt-6">
                        <div class="inline-block min-w-full overflow-hidden rounded-lg shadow">
                            <table class="min-w-full leading-normal">
                                <thead>
                                    <tr>
                                        <th class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">ESTUDIANTE</th>
                                        <th class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">TÍTULO</th>
                                        <th class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">OBSERVACIONES</th>
                                        <th class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">N° REVISIÓN</th>
                                        <th class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">ACCIÓN</th>
                                        <th class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">ESTADO</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="(u, index) in filteredTableData" :key="index">
                                        ...
                                        <td class="px-11 py-5 text-sm bg-white border-b border-gray-200 relative">
                                            <button class="focus:outline-none" @click="toggleDropdown(index)">
                                                <label class="custum-file-upload" for="file">
                                                    <div class="icon">
                                                        <img src="/img/subirarchivo.svg" alt="Icono Subir archivo">
                                                    </div>
                                                    <div class="text">
                                        ...
                                        <td class="px-5 py-5 text-sm bg-white border-b border-gray-200 space-x-1">
            ...
            <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto bg-gray-900 bg-opacity-50">
                <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
                    <div class="flex items-start justify-between p-3 border-b border-gray-200">
                        <h5 class="text-lg font-ligth text-gray-900 text-center flex-1">Confirmación</h5>
                    ...
                    <div class="p-6">
                        <p class="text-gray-600">¿Está seguro que este proyecto de tesis no necesita mas correciones?</p>
                    </div>
                    <div class="flex items-center justify-end p-3 border-t border-gray-200">
                        <button class="px-4 py-2 text-sm text-gray-700 bg-gray-300 rounded-2xl" @click="closeModal">Sí</button>
                        <button class="ml-4 px-4 py-2 text-sm text-white bg-base hover:bg-base rounded-2xl" @click="closeModal">No</button>
                    </div>
                </div>
            </div>
            ...
            <div v-if="showRejectModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto bg-gray-900 bg-opacity-50">
                <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        <p class="text-gray-600">¿Aún le falta correciones a este proyecto de tesis?</p>
                    </div>
                    <div class="flex items-center justify-end p-3 border-t border-gray-200">
                        <button class="px-4 py-2 text-sm text-gray-700 bg-gray-300 rounded-2xl" @click="closeModal">Sí</button>
                        <button class="ml-4 px-4 py-2 text-sm text-white bg-base hover:bg-base rounded-2xl" @click="closeModal">No</button>
            ...
            <div v-if="showArchivo" class="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto bg-gray-900 bg-opacity-50">
                <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
                    <div class="flex items-start justify-between p-3 border-b border-gray-200">
                        <h5 class="text-lg font-ligth text-gray-900 text-center flex-1">Confirmación</h5>
                        <button class="text-gray-900" @click="closeModal">
