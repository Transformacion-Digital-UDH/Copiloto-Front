      ...
      <div class="mt-6 space-y-10">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 relative">
          ...
          <div class="mt-4 space-y-4">
            <DocumentCard titulo='Informe de conformidad - Presidente'
              :estado="obtenerEstadoDocumento(presidenteRevisiones[0]?.estado || '')" :id="presidente_id"
              :view="VIEW_CPA" :download="DOWNLOAD_CPA" />
          </div>

          <!-- INFORME DE CONFORMIDAD POR EL SECRETARIO -->
          <div class="mt-4 space-y-4">
            <DocumentCard titulo='Informe de conformidad - Secretario'
              :estado="obtenerEstadoDocumento(secretarioRevisiones[0]?.estado || '')" :id="secretario_id"
              :view="VIEW_CPA" :download="DOWNLOAD_CPA" />
          </div>
          ...
          <div class="mt-4 space-y-4">
            <DocumentCard titulo='Informe de conformidad - Secretario'
              :estado="obtenerEstadoDocumento(vocalRevisiones[0]?.estado || '')" :id="vocal_id" :view="VIEW_CPA"
