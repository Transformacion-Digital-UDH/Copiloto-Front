  ...
  <template v-else>
    ...
    <template v-else>
      <div class="flex-1 p-10 border-s-2 font-Roboto bg-gray-100">
        <h3 data-tg-tour="En la interfaz que te encuentras actualmente" data-tg-order="3" class="text-4xl font-semibold text-center text-azul">
          {{ textoTipiado }}
        </h3>
        <br />
        <tourGuide>
        ...
        <div data-tg-tour="Botón de inicio" data-tg-order="4" class="bg-white rounded-lg shadow-lg p-6 mt-6 relative">
          ...
          <div class="mt-4">
            <!-- Título de tesis -->
            <label data-tg-tour="Botón de inicio" data-tg-order="5" for="tituloTesis" class="block text-lg font-medium text-gray-700 mb-2">Título de tesis</label>
            <input data-tg-tour="Botón de inicio" data-tg-order="5" id="tituloTesis" type="text" v-model="solicitude.titulo"
          ...
          <span v-if="solicitude.estado === 'pendiente'" class="text-gray-500 italic">Estamos esperando la respuesta del
            asesor. Se mostrará aquí cuando
          ...
          <span v-else-if="solicitude.estado === 'aceptado'" class="text-green-500 italic">El asesor ha aceptado tu
            solicitud, puedes revisar tus documentos
