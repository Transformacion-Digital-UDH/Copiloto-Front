  ...
  <div class="flex-1 p-10 bg-gray-100 font-Roboto">
    ...
    <div class="mt-6 space-y-10">
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="mt-4">
          <p class="text-lg text-gray-800">Haz click en el botón para solicitar jurados.</p>
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        <h2 class="text-2xl font-medium text-black">3. Oficio múltiple con los jurados seleccionados</h2>
