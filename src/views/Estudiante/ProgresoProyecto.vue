    ...
    <div class="mt-6 space-y-10">
      ...
      <div class="bg-white rounded-lg shadow-lg p-6 relative">
        ...
        <div class="overflow-x-auto mt-4 flex justify-center">
          <table class="w-full max-w-7xl bg-white border rounded-md shadow">
            <thead>
              <tr class="text-center text-azul bg-gray-300">
                <th class="px-2 py-2 tracking-wider">DOCUMENTOS</th>
                <th class="px-2 py-2 tracking-wider">EMISOR</th>
                <th class="px-2 py-2 tracking-wider">FECHA EMISIÓN</th>
            ...
            <tbody v-if="documents && documents.length > 0">
              <tr v-for="(doc, index) in documents" :key="index" class="border-b border-gray-200 text-center uppercase">
                ...
                <td class="px-4 py-2 text-base text-gray-600">
                  <p class="">{{ doc.fechaEmision || "Sin fecha" }}</p>
                </td>
                <td class="px-4 py-2 justify-center flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2 w-full">
                  <a 
